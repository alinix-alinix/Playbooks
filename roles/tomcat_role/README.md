# Установка web-сервера tomcat вместе с заббикс-агентом, настроенным на сервер java-разработки. Полностью параметризованный. Кроме томката, настраивает еще и окружение.
